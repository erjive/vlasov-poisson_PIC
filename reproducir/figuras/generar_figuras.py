...
Uso, desde este directorio (reproducir/figuras):
...
exe/sg, que no se versionan; se regeneran con reproducir/correr.sh.
Las figuras se escriben en docs/introduccion/figuras.
...
AQUI = os.path.join(RAIZ, 'docs', 'introduccion', 'figuras')     # destino de los PDF
