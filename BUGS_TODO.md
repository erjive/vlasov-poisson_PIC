...
- [ ] La revisión de `VlasovPoisson_PIC_sp` (commit `a81f4cf` de ese repositorio)
  ...
  2026-09-21** (E6): se recalcula la fuerza después de reducir. **Estado `gaussian`: corregido el
  ...
  **Imágenes en el depósito: corregido el 2026-09-22** (E9): la masa de una partícula cerca del
  ...
  la conservación de la energía pasa de 1.7e-7 a 5.3e-7: es error espacial (no depende de dt)
  que baja con dr con orden ≈ 1.6; el RK2 daba menos en dr = 0.1 pero no convergía.
  **Interpolación con espejo y solución exterior: corregido el 2026-09-22** (E10): la fuerza
  ...
  diferían en 9 de 11 energías. **Estados muertos: quitados el 2026-09-23** (E19): 112 líneas
  de `initial_data` que `paramfile` no admite. El resto sigue pendiente. En `_sp` una esfera uniforme daba fuerza 3.7–5 veces la exacta en r=0.01 y
